...
import (
	...
	pb "github.com/esmaeel67/golang-modular-app/payments/paymentspb"
...
func (s server) AuthorizePayment(ctx context.Context, request *pb.AuthorizePaymentRequest) (*pb.AuthorizePaymentResponse, error) {
	id := uuid.New().String()
...
func (s server) ConfirmPayment(ctx context.Context, request *pb.ConfirmPaymentRequest) (*pb.ConfirmPaymentResponse, error) {
...
func (s server) AdjustInvoice(ctx context.Context, request *pb.AdjustInvoiceRequest) (*pb.AdjustInvoiceResponse, error) {
